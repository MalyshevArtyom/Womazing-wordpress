...
$opt_name = 'womazingredux';  // YOU MUST CHANGE THIS.  DO NOT USE 'redux_demo' IN YOUR PROJECT!!!
...
Redux::set_section(
	$opt_name,
	array(
		'title'            => esc_html__( 'Верхняя часть', 'your-textdomain-here' ),
		'id'               => 'header',
		'desc'             => esc_html__( 'Редактирование верхней части', 'your-textdomain-here' ),
...
require_once get_template_directory() . '/inc/redux-components/header.php';
...
Redux::set_section(
	...
	array(
		...
		'id'               => 'home',
		'desc'             => esc_html__( 'Редактирование главной страницы', 'your-textdomain-here' ),
...
require_once get_template_directory() . '/inc/redux-components/home/important.php';
require_once get_template_directory() . '/inc/redux-components/home/bottom-section.php';


// -> START Страница О бренде
Redux::set_section(
	$opt_name,
	array(
		'title'            => esc_html__( 'О бренде', 'your-textdomain-here' ),
		'id'               => 'about',
		'desc'             => esc_html__( 'Редактирование страницы о бренде', 'your-textdomain-here' ),
		'icon'             => 'el el-podcast',
	)
);

require_once get_template_directory() . '/inc/redux-components/about/main-section.php';
...
require_once get_template_directory() . '/inc/redux-components/contacts/contacts-section.php';

// -> START Нижняя страница
Redux::set_section(
	$opt_name,
	array(
		'title'            => esc_html__( 'Нижняя страница', 'your-textdomain-here' ),
		'id'               => 'footer',
		'desc'             => esc_html__( 'Редактирование нижней страницы', 'your-textdomain-here' ),
		'icon'             => 'el el-star',
	)
);
